<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Root.master" CodeBehind="Scheduler.aspx.cs" Inherits="x50.ASPxGridView.SchedulerModule" Title="Scheduler" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <asp:ObjectDataSource ID="AppointmentDataSource" runat="server" DataObjectTypeName=" x50.ASPxGridView.Model.SchedulerAppointment"
        TypeName=" x50.ASPxGridView.Model.AppointmentDataSourceHelper"
    ...
    <asp:ObjectDataSource ID="ResourcesDataSource" runat="server" DataObjectTypeName=" x50.ASPxGridView.Model.SchedulerResource"
        TypeName=" x50.ASPxGridView.Model.ResourceDataSourceHelper"
